"""
Django settings for pet_clinic_billing_service project.
...
SECRET_KEY = "django-insecure-ee8=1d9z*upaj2#(8)dyuz)g+$ivc)!$fy8l84cqonc(k(-dth"
...
ROOT_URLCONF = "pet_clinic_billing_service.urls"
...
WSGI_APPLICATION = "pet_clinic_billing_service.wsgi.application"
