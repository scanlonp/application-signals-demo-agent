...
docker tag springcommunity/spring-petclinic-api-gateway:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-api-gateway:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-api-gateway:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-api-gateway:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-discovery-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-discovery-server:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-discovery-server:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-discovery-server:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-config-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-config-server:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-config-server:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-config-server:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-visits-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-visits-service:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-visits-service:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-visits-service:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-vets-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-vets-service:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-vets-service:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-vets-service:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-customers-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-customers-service:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-customers-service:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-customers-service:${COMMIT_SHA}
...
docker tag springcommunity/spring-petclinic-admin-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-admin-server:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-admin-server:latest
docker push ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-admin-server:${COMMIT_SHA}
...
docker tag insurance-service:latest ${REPOSITORY_PREFIX}/python-petclinic-insurance-service:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/python-petclinic-insurance-service:latest
docker push ${REPOSITORY_PREFIX}/python-petclinic-insurance-service:${COMMIT_SHA}
...
docker tag traffic-generator:latest ${REPOSITORY_PREFIX}/traffic-generator:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/traffic-generator:latest
docker push ${REPOSITORY_PREFIX}/traffic-generator:${COMMIT_SHA}
...
docker tag otel-collector:latest ${REPOSITORY_PREFIX}/otel-collector:${COMMIT_SHA}
docker push ${REPOSITORY_PREFIX}/otel-collector:latest
docker push ${REPOSITORY_PREFIX}/otel-collector:${COMMIT_SHA}
