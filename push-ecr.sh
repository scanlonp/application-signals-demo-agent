...
docker tag springcommunity/spring-petclinic-api-gateway:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-api-gateway:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-discovery-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-discovery-server:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-config-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-config-server:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-visits-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-visits-service:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-vets-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-vets-service:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-customers-service:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-customers-service:${AWS_EXECUTION_ENV}
...
docker tag springcommunity/spring-petclinic-admin-server:latest ${REPOSITORY_PREFIX}/springcommunity/spring-petclinic-admin-server:${AWS_EXECUTION_ENV}
...
docker tag insurance-service:latest ${REPOSITORY_PREFIX}/python-petclinic-insurance-service:${AWS_EXECUTION_ENV}
...
docker tag billing-service:latest ${REPOSITORY_PREFIX}/python-petclinic-billing-service:${AWS_EXECUTION_ENV}
...
docker tag nutrition-service:latest ${REPOSITORY_PREFIX}/nodejs-petclinic-nutrition-service:${AWS_EXECUTION_ENV}
...
docker tag traffic-generator:latest ${REPOSITORY_PREFIX}/traffic-generator:${AWS_EXECUTION_ENV}
...
docker tag dotnet-petclinic-payment:latest ${REPOSITORY_PREFIX}/dotnet-petclinic-payment:${AWS_EXECUTION_ENV}
...
docker tag otel-collector:latest ${REPOSITORY_PREFIX}/otel-collector:${AWS_EXECUTION_ENV}
